...
[#51](https://github.com/urbinn/urbinn/issues/51) | **Issue 51 :  ORB2 extracten points naar csv file**  <br> Om de evaluatie uit te voeren hebben we de gegenereerde point cloud nodig om de nauwkeurigheid van de algoritme te bepalen. De functionaliteit was toegevoegd en gemerged met de master branch. [Code](code/toCSV.cpp) 
...
[#58](https://github.com/urbinn/urbinn/issues/58) | **Issue 58 :  Beschrijven data structuur MapPoint in ORB2** <br>  De source code was volledig gedocumenteerd.  Ik heb documentatie toegevoegd aan de source code. Dit is voor de map point structuur gedaan. 
[#60](https://github.com/urbinn/urbinn/issues/60) |  **Beschrijven structuur KeyFrameDatabase in ORB2** <br> De ORB SLAM2 bevatte geen commentaar. Om  de code duidelijk te maken heb ik commentaar bij de methodes gezet.
[#72](https://github.com/urbinn/urbinn/issues/72) | **Issue 72 :  Resutaten ORB2 bin exporteren** <br> ORB SLAM2 is in c++ geschreven. Om het import tool te maken moest ik een functie maken in c++ die de output van ORB SLAM 2 kon exporteren. De geexporteerde data moest door andere programma's geïmporteerd kunnen worden.
...
[#80](https://github.com/urbinn/urbinn/issues/79) | **Issue 80 :  ORB output uitbreiden met keyframe coordinaten** <br> De coordinaten van keyframes waren nodig bij de output. De coordinaten moesten opbieuw geimporteerd worden om de een accuraat pointcloud te maken.
...
[#89](https://github.com/urbinn/urbinn/issues/89) | **Issue 89 :  import xml data (pointcloud) orbslam2** <br> De data die in een xml formaat was opgeslagen moest opnieuw geimporteerd worden. Ik heb een methode daarvoor gemaakt. Zo is het mogelijk om in xml geexporteerd data opnieuw te importeren. 
...
[#106](https://github.com/urbinn/urbinn/issues/106) | **Issue 106 :  Orb2 stability fix** <br> Ik heb een paar memory leaks in orb slam 2 gevonden. Ik heb deze dan gefixt. Ik heb Instruments en GNU debugger hiervoor gebruikt. 
...
[#134](https://github.com/urbinn/urbinn/issues/134) | **Issue 134 :  Een centrale repository maken van Pyurb en g2o**  <br> Er waren verschillende repositories waar apart in werd gewerkt. Jeroen en ik hebben een centrale repositry opgezet waar iedereen kan werken. Dit heeft voor overzicht van alle code gezorgd.
[#136](https://github.com/urbinn/urbinn/issues/136) |  **Issue 136 :  Full BA code schrijven**  <br> De full bundle adjustment moest voor Urb gemaakt worden. Ik heb de full BA code gemaakt. [Code](code/full_ba.cpp) 
[#137](https://github.com/urbinn/urbinn/issues/137) |  **Issue 137 :  Handmatig bepalen welke frame overlappen op Sequence 07 KITTI** <br> Om de Full bundle adjustment uit te testen hebben we handmatig bepaald welke frames op ongeveer de zelfde locatie zijn. Door de landmark matches te controleren konden we nagaan of de frames wel gelijke mappoint hebben. 
[#145](https://github.com/urbinn/urbinn/issues/145) | **Issue 145 :  Urb BA code testen en debuggen** <br> We kregen geen output die we konden gebruiken van de local BA. Ik was hierdoor bezig om de BA code te controleren. We hebben ook testen ervoor gemaakt. 
